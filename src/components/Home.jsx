    ...
    const fetch = async () => {
      try {
        const respone = await axios.get(
          "http://localhost:5000/api/auth/getRoute"
        );
        if (respone.data.success === "success") {
          setFeedback(respone.data.route);
        }
  ...
  return (
    <div className="flex flex-col scroll-smooth gap-30 md:gap-80 overflow-hidden pb-10 md:pb-5 ">
      <motion.div
        ...
        className="flex flex-col justify-between w-[100%] m-auto md:flex-row  md:h-[88vh]"
      >
        <div className="h-[100%]  w-[100%] rounded-2xl m-auto overflow-hidden md:w-[90%] md:h-[93%]">
          ...
          >
            <div className="relative z-10 w-[full] md:w-1/2 flex flex-col items-center md:items-start justify-center space-y-6">
              ...
              <motion.p
                variants={textVariants}
                className="text-xl md:text-2xl text-gray-300 text-center md:text-left"
              >
                Visualize, understand, and master algorithms through interactive
                exploration
              </motion.p>
      ...
      <div
        id="content"
        className="flex flex-col justify-between gap-30 md:gap-5 w-[100%] md:w-[90%] m-auto rounded-2xl  md:flex-row md:h-[85vh]"
      >
        <Tilt
          tiltMaxAngleX={-5}
          tiltMaxAngleY={5}
        ...
        >
          <motion.div
            ...
            onMouseMove={handleMouseMove}
            className="box md:shadow-[0px_0px_20px_inset] shadow-sky-400 relative h-full rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div
              initial={{ opacity: 0, y: -100 }}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <motion.div className="flex items-center space-x-3">
                  ...
                  <motion.h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-cyan-300">
                    Sorting Algorithms
                  </motion.h2>
                </motion.div>
              ...
              <motion.p className="text-gray-300 mb-6">
                Explore the fascinating world of sorting algorithms, from the
                simple Bubble Sort to the efficient Quick Sort. Understand how
                different algorithms perform under various conditions and data
                sets.
              </motion.p>
              ...
              >
                ...
                <img
                  src={sorting}
                  alt="Sorting Algorithms Visualization"
              ...
              <div className="space-y-3 mt-auto">
                <div className="flex items-center gap-3 bg-blue-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Visualize how algorithms scale with input size
                    </p>
                  </div>
                  <div></div>
                </div>
                <div className="flex items-center gap-3 bg-blue-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      See real-time speed differences between algorithms
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-blue-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Watch how each algorithm transforms data
                    </p>
                  </div>
                </div>
              </div>
              <NavLink
                ...
                className="mt-6 group flex items-center text-blue-400 font-medium"
              >
        ...
        >
          <motion.div
            ...
            onMouseMove={handleMouseMove}
            className="box5 relative w-[98%] md:shadow-[0px_0px_20px_inset] shadow-pink-700 h-full rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div
              initial={{ opacity: 0, y: 100 }}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-emerald-300">
                    Graph Algorithms
                  </h2>
                </div>
              ...
              <p className="text-gray-300 mb-6">
                Dive into the powerful world of graph algorithms that solve
                complex problems in networks, pathfinding, and optimization.
                Visualize how these algorithms navigate through connected data
                structures.
              </p>
              ...
              <div className="relative overflow-hidden rounded-xl mb-6 group">
                ...
                <img
                  src={Graph}
                  alt="Graph Algorithms Visualization"
                  className="w-full h-48 object-cover group-hover:scale-105 group-hover:opacity-90 transition-transform duration-500"
                />
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                  <span className="text-white font-medium">
              ...
              <div className="space-y-3 mt-auto">
                <div className="flex items-center gap-3 bg-yellow-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Dijkstra's, A*, and Bellman-Ford visualized
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-blue-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Kruskal's and Prim's algorithms in action
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-purple-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Ford-Fulkerson and Push-Relabel methods
                    </p>
                  </div>
                </div>
              </div>
      ...
      <div className="flex flex-col md:flex-row justify-between gap-30 md:gap-5 w-[100%] md:w-[90%] m-auto rounded-2xl">
        <Tilt
          tiltMaxAngleX={-5}
          tiltMaxAngleY={5}
          perspective={1000}
        ...
        >
          <motion.div
            ...
            onMouseMove={handleMouseMove}
            className="box  md:shadow-[0px_0px_20px_inset] shadow-rose-800  h-full rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div
              initial={{ opacity: 0, x: 100 }}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-400 to-amber-300">
                    Data Structures
                  </h2>
                </div>
              ...
              <p className="text-gray-300 mb-6">
                Understand the building blocks of efficient algorithms through
              ...
              <NavLink
                to="/visualizer"
                className="mt-6 group flex items-center text-orange-400 font-medium "
              >
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            onMouseMove={handleMouseMove}
            className="box4 h-full  md:shadow-[0px_0px_20px_inset] shadow-purple-900 rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div
              initial={{ opacity: 0, y: -100 }}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-fuchsia-300">
                    {" "}
                    Dynamic Programming
                  </h2>
                </div>
              ...
              <p className="text-gray-300 mb-6">
                Master the art of solving complex problems by breaking them down
                into simpler subproblems with optimized solutions.
              </p>
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.5 }}
            onMouseMove={handleMouseMove}
            className="box2 md:shadow-[0px_0px_20px_inset] shadow-sky-700 h-full rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div
              initial={{ opacity: 0, x: -100 }}
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-2xl md:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-indigo-300">
              ...
              <p className="text-gray-300 mb-6">
                Understand the theoretical foundations of algorithm analysis and
                learn to predict performance characteristics.
              </p>
              <div className="relative overflow-hidden rounded-xl mb-6 group">
                <div className="absolute inset-0 bg-gradient-to-r from-blue-600/20 to-indigo-600/20 mix-blend-luminosity rounded-[1rem]"></div>
                <img
                  src={TimeSpaceComplexity}
                  className="w-full h-48 object-cover group-hover:scale-105 transition-transform duration-500"
                />
      ...
      <motion.div
        ...
        className="flex flex-col justify-between gap-30  md:gap-5  w-[100%] md:w-[90%] m-auto rounded-2xl  md:flex-row mb-10"
      >
        <div className="h-[100%]  rounded-2xl md:w-[48%] overflow-hidden mb-5 md:mb-0">
          <motion.div
            ...
            onMouseMove={handleMouseMove}
            className="box4 relative h-full rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div className="relative z-10 p-6 h-full flex flex-col">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  <div className="p-3 bg-green-500/20 rounded-xl">
                    <Brain className="text-green-400 h-8 w-8" />
                  </div>
                  <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-green-400 to-teal-300">
              ...
              <p className="text-gray-300 mb-6">
                Ace your technical interviews with our comprehensive collection
                of common DSA problems. Practice with interactive visualizations
                that help you understand the underlying patterns and solutions.
              </p>
              ...
              <div className="space-y-3 mt-auto">
                <div className="flex items-center gap-3 bg-blue-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Interactive solutions with visualizations
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-purple-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Learn to identify problem categories
                    </p>
                  </div>
                </div>
                <div className="flex items-center gap-3 bg-yellow-900/20 p-3 rounded-lg">
        ...
        <div className="h-[100%]  rounded-2xl md:w-[48%] overflow-hidden mb-5 md:mb-0">
          <motion.div
            ...
            transition={{ duration: 0.7 }}
            onMouseMove={handleMouseMove}
            className="box5 relative h-full rounded-2xl overflow-hidden"
            style={{ "--x": position.x, "--y": position.y }}
          >
            <motion.div className="relative z-10 p-6 h-full flex flex-col">
              <div className="flex items-center justify-between mb-4">
                <div className="flex items-center space-x-3">
                  ...
                  <h2 className="text-3xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-400 to-amber-300">
              ...
              <p className="text-gray-300 mb-6">
                Discover how DSA powers the technology we use every day. From
                search engines to social networks, understand the algorithms
                behind modern applications through interactive case studies.
              </p>
              ...
              <div className="space-y-3 mt-auto">
                <div className="flex items-center gap-3 bg-green-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      PageRank and indexing algorithms
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3 bg-blue-900/20 p-3 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400">
                      Collaborative filtering visualized
                    </p>
                  </div>
                </div>
      ...
      <div className="flex flex-col justify-between m-auto rounded-2xl md:flex-row md:w-[90%] md:h-[85vh] mb-5 md:5">
        ...
        >
          <motion.div
            ...
            transition={{ duration: 0.7 }}
            onMouseMove={handleMouseMove}
            className="box flex flex-col items-center justify-center h-[50%]  md:w-[100%] md:h-[100%] p-6 md:p-10"
            style={{ "--x": position.x, "--y": position.y }}
          >
              ...
              <div className="space-y-2 rounded-2xl p-4 pl-5 shadow-lg shadow-blue-300 md:w-[50%]">
                <div>
                  ...
                  <p className="text-sm text-left md:text-xl text-gray-400">
                    Empowering developers with interactive data structure
                    visualizations and comprehensive learning resources.
                  </p>
                </div>
                <div className="flex gap-10">
                  <div className="space-y-2">
                    <h1 className="text-2xl md:text-4xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500">
                      Resources
                    </h1>
                ...
                <div className="flex flex-col text-white space-y-5">
                  ...
                  <div className="flex  space-x-5">
                    <a href="https://github.com/satyamyadav04">
                      {" "}
                ...
                <div>
                  <div className="w-[90%] md:w-[85%] mx-auto mt-6 flex flex-col gap-3 min-h-[100px]">
                    {FeedBack && FeedBack.length > 0 ? (
                      FeedBack.map((fee) => (
                        <div
                          key={fee._id}
                          className="bg-gray-800 text-gray-200 px-4 py-2 rounded-md shadow shadow-pink-800"
                        >
